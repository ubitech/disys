...
$(document).ready(function(){
	...
	/*$('.calendar-small').fullCalendar({
		...
		events: [
			{
				title: 'New Cards Promo',
				start: new Date(date.getFullYear(), date.getMonth(), date.getDate() -17),
				allDay: true
			},
			{
				title: 'Country Elections',
				start: new Date(date.getFullYear(), date.getMonth(), date.getDate() -12, 07,15,0),
				end: new Date(date.getFullYear(), date.getMonth(), date.getDate()-12, 19,42,0)
			},
			{
				id: 999,
				title: 'Loan Advertisement',
			...
			{
				title: 'American Financial Crisis',
			...
			{
				title: 'Financial Group Bankruptcy',
			...
			{
				title: 'Countrywide Bankers Meeting',
